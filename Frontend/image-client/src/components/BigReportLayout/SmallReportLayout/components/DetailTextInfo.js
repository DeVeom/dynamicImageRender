...
function DetailTextInfo({
  ...
  return (
    <g>
      <g>
        <text className={style.detailInfoTitle} x="21" y="40">
          구독자 등급
        </text>
        <text className={style.detailInfo} x="470" y="40">
      ...
      <g>
        <text className={style.detailInfoTitle} x="20" y="72">
          구독자수
        </text>
        <text className={style.detailInfo} x="470" y="72">
          {getRoundNumber(subscriberCount)}
        </text>
      </g>
      <g>
        <text className={style.detailInfoTitle} x="20" y="104">
          채널 가입일
        </text>
        <text className={style.detailInfo} x="470" y="104">
          {getPublishDate(publishedAt)}
        </text>
      </g>
      <g>
        <text className={style.detailInfoTitle} x="20" y="136">
          총 영상수
        </text>
        <text className={style.detailInfo} x="470" y="136">
          {videoTotalCount}
        </text>
      </g>
    </g>
